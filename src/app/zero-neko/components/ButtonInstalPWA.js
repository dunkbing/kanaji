...
const ButtonInstallPWA = () => {
  ...
  return (
    <button onClick={onClick} className="flex transition-colors duration-150 mx-auto px-4 py-2 lg:px-6 lg:py-3 lg:ml-0 lg:mr-auto space-x-4 bg-green-400 hover:bg-green-500 rounded-lg text-white">
