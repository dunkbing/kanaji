...
const KanjiBox = (props) =>{
    ...
    const loading = (
        <li className="box-border transition-all delay-75 col-span-1 rounded-md bg-gray-50 p-2 py-8 shadow-md hover:shadow-none">
    ...
    return(
        <li className="box-border col-span-1 rounded-md bg-gray-50 shadow-md hover:shadow-none hover:cursor-pointer">
