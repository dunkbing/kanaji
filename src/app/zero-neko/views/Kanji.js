            ...
            <div className="flex flex-col pb-4 px-1 ">
                <div className="flex flex-col lg:flex-row pt-4">
                    ...
                    <div className="relative lg:ml-2 my-auto">
                        ...
                        <button onClick={() => {setModal(!modal)}} className="flex bg-gray-50 rounded-lg shadow hover:bg-gray-100 text-lg px-4 py-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary ring-offset-4">
                        ...
                        {/* Modal */}
                        <div className={(modal ? "flex" : "hidden")+" absolute left-32 top-8 rounded-lg w-32 bg-white shadow-lg flex-col ml-auto px-3 py-3 z-10"}>
